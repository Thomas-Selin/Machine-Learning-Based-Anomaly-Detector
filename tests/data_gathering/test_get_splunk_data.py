...
from ml_monitoring_service.configuration import ConfigLoader, get_services
...
def test_download_splunk_data_file_path():
    with patch('ml_monitoring_service.data_gathering.get_splunk_data.download_splunk_data_in_batches') as mock_download:
