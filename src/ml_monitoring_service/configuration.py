...
class ConfigLoader:
    ...
    def __init__(self, config_path: str = "src/ml_monitoring_service/resources/service_sets.yaml"):
    ...
    def get_config(self, service_set: Optional[str] = None) -> ServiceSetConfig:
    ...
    def get_services(self, service_set: Optional[str] = None) -> List[str]:
